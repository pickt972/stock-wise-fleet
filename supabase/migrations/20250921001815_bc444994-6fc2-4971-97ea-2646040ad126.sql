...
-- Insérer les emplacements existants depuis la table articles (correction du type)
INSERT INTO public.emplacements (nom, actif)
SELECT DISTINCT emplacement, true
FROM public.articles 
WHERE emplacement IS NOT NULL 
  AND emplacement != ''
ON CONFLICT (nom) DO NOTHING;

-- Ajouter une clé étrangère vers la table emplacements
