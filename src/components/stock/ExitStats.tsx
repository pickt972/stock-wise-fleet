import { TrendingDown, PackageMinus, AlertTriangle } from "lucide-react";
...
export function ExitStats({ todayCount, monthCount, rentalCount }: ExitStatsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-3 mb-6">
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Accessoires en location</p>
